<?php
/**
* Template Name: Invoice Processing
 */
    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <br/> <br/>
          Built with a dashboard that gives end-to-end visibility of the entire invoice process, our Hyper App provides comprehensive analysis and insights into your financial data – allowing you to report on time and with confidence.</p>
        </div>
      </div>
    </div>
  </section>
